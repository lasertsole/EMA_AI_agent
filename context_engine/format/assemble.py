...
class NodeWithSource(TypedDict):
    """带来源标记的节点"""
    id: str
    type: str
    name: str
...
def assemble_context(
    ...
    all_edges = active_edges + recalled_edges
    ...
    if edges:
        ...
        for e in edges:
            ...
            cond_attr = f' when="{escape_xml(e["condition"])}"' if e.get('condition') else ''
