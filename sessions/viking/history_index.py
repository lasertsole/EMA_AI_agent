...
async def append_timeline_entry(
    ...
    try:
        ...
        system = (
            ...
            "L1 是详细摘要，要包含具体的：\n"
            " - 技术方案（用了什么步骤、什么方法）\n"
            " - 如果是程序配置类别的详情：文件路径、配置参数的具体值 如果是其他类别的详情：具体材料、参数等\n"
            " - 如果是程序配置类别的详情：代码改动（改了哪个文件、具体改了什么逻辑、为什么改） 如果是其他类别的详情：做了什么 遵循什么逻辑 为什么这么做 等\n"
            " - 如果是程序配置类别的详情：bug的根因和修复方式 如果是其他类别的详情：事件归因和解决方法\n"
            " - 确认的结论和共识\n\n"
